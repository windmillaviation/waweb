          ...
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Premier Aircraft
                <span className="block text-primary">Trading & Parts Supplier</span>
              </h1>
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                Your trusted partner for aircraft trading, parts supply, and comprehensive aerospace asset solutions. We maximize value through strategic acquisitions, inventory management, and global distribution networks.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a className="inline-flex items-center justify-center gap-2 border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground font-semibold h-14 rounded-lg px-10 text-base" href="#contact">
                Schedule Trading Portfolio Review
              </a>
            </div>
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 pt-8">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm font-medium">FAA Certified Trading & Parts Specialists</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm font-medium">500+ Trading Partners & Parts Customers</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm font-medium">Over 25 Years in Aircraft Trading & Parts</span>
              </div>
            </div>
          </div>
