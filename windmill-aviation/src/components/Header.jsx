      ...
      {open && (
        <nav className="md:hidden container pb-4">
          <div className="rounded-lg border border-border bg-card p-2 shadow-card">
            <a className="block px-4 py-3 hover:bg-accent rounded-md font-medium" onClick={() => setOpen(false)} href="#about">About</a>
            <a className="block px-4 py-3 hover:bg-accent rounded-md font-medium" onClick={() => setOpen(false)} href="#services">Services</a>
            <a className="block px-4 py-3 hover:bg-accent rounded-md font-medium" onClick={() => setOpen(false)} href="#contact">Contact</a>
